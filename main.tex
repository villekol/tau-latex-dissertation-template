...
%% Unfortunately, if you update this metadata,
%% the changes won't make it to the PDF before
%% you've also deleted the auxiliary files
%% (cleared the cached files).
%% Always check your metadata using a PDF reader
